  ...
  return (
    <div className="sidebar " style={{ width: props.width }} >
      ...
      <ul className="sidebar-menu">
        ...
        <li style={props.drawer ? style.SideNavIconDecor : style.SideNavIconDecorAfter} onClick={() => { toggleSelect("Incident"); setIsComponentsOpen(false); setIsCMDBOpen(false); setIncidentOpen(!incidentOpen); setChangeOpen(false); setRequestOpen(false) }}>
        ...
        {/* <hr /> */}
        <div onClick={() => { toggleSelect("CMDB"); setIsComponentsOpen(false); setIsCMDBOpen(false); setIncidentOpen(false) }} className={!cmdbClicked || !props.drawer ? 'sidebar-hover-container' : "sidebar-hover-container-select"} >
          <li className="sidebar-item">
        ...
        {/* <hr /> */}
        <li style={props.drawer ? style.SideNavIconDecor : style.SideNavIconDecorAfter} onClick={() => { toggleSelect("Request"); setIsComponentsOpen(false); setIsCMDBOpen(false); setRequestOpen(!requestOpen); setChangeOpen(false); setIncidentOpen(false) }}>
          <Link style={{ textDecoration: "none" }}>
        ...
        <li style={props.drawer ? style.SideNavIconDecor : style.SideNavIconDecorAfter} onClick={() => { toggleSelect("Change"); setIsComponentsOpen(false); setIsCMDBOpen(false); setChangeOpen(!changeOpen); setIncidentOpen(false) }}>
          <Link style={{ textDecoration: "none" }}>
        ...
        <div className={!knowledgeClicked || !props.drawer ? 'sidebar-hover-container' : "sidebar-hover-container-select"} onClick={() => { toggleSelect("Knowledge"); setIsComponentsOpen(false); setIsCMDBOpen(false); setIncidentOpen(false); setRequestOpen(false) }}>
          <li className="sidebar-item">
