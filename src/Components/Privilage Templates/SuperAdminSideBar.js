...
export default function SuperAdminSideBar(props){
  ...
  const[formGenerator,setFormGeneratorClicked]=useState(false);
...
const userEmail = localStorage.getItem("userEmail");
  ...
  const toggleSelect = (parameter)=>{
      ...
      FormGenerator:setFormGeneratorClicked,
    };
    ...
    <div className="sidebar " style={{width:props.width}} >
      ...
      <ul className="sidebar-menu">
       ...
       {props.drawer? <hr className='sidenav-hr'/>:null}
         ...
         {props.drawer? <p style={style.FontSize}  className="fontStyle">Request Management</p>:null}
          ...
          <ol className={`dropdown ${requestOpen ? 'open' : ''}`} >
            ...
            <Link onClick={()=>{window.location.href="/request_service/my_requests"}}>
               <p style={style.listFontSize}  className="fontStyle">All Request</p>
             </Link>
            </li>
            <li className="dropdown-item">
        ...
        {props.drawer?<hr className="sidenav-hr"/>:null}
        {/* {props.drawer?<hr className="sidenav-hr"/>:null} */}
        <div className={!GenerateTokenClicked || !props.drawer?'sidebar-hover-container':"sidebar-hover-container-select"} onClick={()=>{toggleSelect("GenerateToken");setIsComponentsOpen(false);setIsCMDBOpen(false)}}>
        <li className="sidebar-item">
        ...
        <div style={{marginTop:-15,marginLeft:10}}className={!userManagementClicked || !props.drawer?'sidebar-hover-container':"sidebar-hover-container-select"} onClick={()=>{toggleSelect("userManagement");setIsComponentsOpen(false);setIsCMDBOpen(false)}}>
        <li className="sidebar-item">
          <Link to="/user-list">
          ...
          <Tooltip title="Generate Token">
              <GroupIcon  className="fontStyle" style={{fontSize:28,marginLeft:-10,marginTop:-30}}/>
          </Tooltip>
            {/* <p style={{fontSize:20}}>Knowledge article</p> */}
          </div>}
          </Link>
        ...
        <div onClick={()=>{toggleSelect("FormGenerator");setIsComponentsOpen(false);setIsCMDBOpen(false);setFormGeneratorClicked(true)}} className={!formGenerator || !props.drawer?'sidebar-hover-container':"sidebar-hover-container-select"} >
        <li className="sidebar-item">
          <Link to="/form-menu" style={{textDecoration:"none"}}>
          {props.drawer?<div className="sidebar-item-decor"  style={{marginTop:-15,width:"86%"}}>
          <AiOutlineForm className="fontStyle" style={{fontSize:25}}/>
             <p style={style.FontSize}  className="fontStyle">Form Generator</p>
          </div>:<div className="sidebar-item-decor"  style={{marginTop:10,width:"45%"}}>
        ...
        <div className={!CMDBManagerClicked || !props.drawer?" sidebar-hover-container":"sidebar-hover-container-select"} onClick={()=>{toggleSelect("CMDBManager");setIsCMDBOpen(!isCMDBOpen);setIsComponentsOpen(false)}}>
        <li >
          <Link style={{textDecoration:"none"}}>
