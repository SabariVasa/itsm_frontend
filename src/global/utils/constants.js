...
export const apicontext = process.env.REACT_APP_API_CONTEXT;
export const cookiedomain = process.env.REACT_APP_COOKIEDOMAIN;

export const restbaseurl = `${process.env.REACT_APP_EXEC_PROTOCOL}://${process.env.REACT_APP_API_DOMAIN}/api/v1/`;
