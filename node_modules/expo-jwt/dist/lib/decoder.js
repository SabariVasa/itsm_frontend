...
var parse = function (encodedString) {
    var safeEncodeString = (0, helpers_1.urlSafeBase64ToBase64)(encodedString);
    return JSON.parse(enc_base64_1.default.parse(safeEncodeString).toString(enc_utf8_1.default));
};
